...
1. [R5D6] 支持当期UP角色显示 *在顶部*
2. [R5D6] 更改了`announce.json`的缓存位置 *一直没发现这文件呆在主目录，挺碍眼*
3. [R5D6] 新增了API: `information.Information` *算是API化第一步*
4. [R5D6] 新增了API函数: `get_up_character` *获取当期五星UP角色*
5. [R5D6] 新增了工具箱功能 *暂时是个框架*

### 2022.9.30

1. [R5D5] 修复了关于3.1公告加载的问题
