### 2023.5.4
1. [R7D7] 删除了`ThemeManager`
2. [R7D7] 更新了UI库版本 `0.8.2 -> 0.8.4`
3. [R7D7] 重构了代码结构
4. [R7D7] 完善了`GachaReport`和`Announcement`部分
5. [R7D7] 新增了一个自定义信息框`CustomMsgBox.TextEditMsgBox`
6. [R7D7] 设置内的缓存清空栏可以显示当前缓存文件夹的占用大小
7. [R7D7] 删除了`Plugin`模块
