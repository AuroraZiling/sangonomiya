### 2023.5.3
1. [R7D7] 清空了仓库的Python编译文件
2. [R7D7] 公告内容将不会在程序内呈现
3. [R7D7] 在一定程度上修复了无法最大化窗口的问题
4. [R7D7] 新增了清空缓存的功能
5. [R7D7] 新增了导入导出的UI
6. [R7D7] 修复了打开程序后，公告的标题并未显示为第一则公告的标题
7. [R7D7] 完善了infoBars的封装
8. [R7D7] 公告更新后会弹出成功的框
9. [R7D7] 修复了在没有数据的情况下，祈愿记录的表格没有填满UI的问题
10. [R7D7] 新增了导航栏的返回按钮
11. [R7D7] 新增了在没有账户数据的情况下，打开祈愿记录的警告提醒
12. 
