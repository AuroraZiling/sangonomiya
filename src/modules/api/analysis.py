character_5_w_list = ["迪希雅", "七七", "提纳里", "刻晴", "迪卢克", "莫娜", "琴"]
character_5_list = ["白术", "艾尔海森", "流浪者", "纳西妲", "赛诺", "妮露", "钟离", "宵宫", "可莉", "枫原万叶", "荒泷一斗", "夜兰", "魈", "神里绫华", "神里绫人",
                    "温迪", "八重神子", "甘雨", "申鹤", "优菈", "阿贝多", "胡桃", "达达利亚", "珊瑚宫心海", "雷电将军",
                    "七七", "刻晴", "迪卢克", "莫娜", "提纳里", "琴", "迪希雅"]
character_4_list = ["卡维", "米卡", "瑶瑶", "珐露珊", "莱依拉", "坎蒂丝", "柯莱", "鹿野院平藏", "久岐忍", "云堇", "五郎", "托马", "九条裟罗", "罗莎莉亚", "早柚", "雷泽",
